...
python3 scripts/run_scenario.py --id 05 --check

# O mediante consulta REST al Flag Service:
curl -s http://10.0.2.20:8570/api/flag/mint/05/FLAG_1

# Enviar flag obtenida para registro en el Scoreboard:
python3 scripts/run_scenario.py --id 05 --submit "FLAG_1{...}" --team "tu_equipo"
```
